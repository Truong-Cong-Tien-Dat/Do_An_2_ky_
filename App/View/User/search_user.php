...
$html_show_product = $show_product->show_product_u($data['list_product']);
?>

<section id="main">

    <div>
        <form class="mb-3 input-group" action="index.php?action=search_u" method="post" enctype="multipart/form-data"
